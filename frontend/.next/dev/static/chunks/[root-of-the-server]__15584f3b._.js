            ...
            const fetchProducts = {
                "HomePage.useEffect.fetchProducts": async ()=>{
                    try {
                        ...
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_BASE"]}/api/products`);
                        if (!response.ok) {
            ...
            const fetchWishlist = {
                "HomePage.useEffect.fetchWishlist": async ()=>{
                    try {
                        ...
                        if (!token) return;
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_BASE"]}/api/customers/wishlist`, {
                            headers: {
                                'Authorization': `Bearer ${token}`
                            }
                        });
    ...
    const toggleWishlist = async (id)=>{
        ...
        try {
            ...
            if (isCurrentlyWishlisted) {
                ...
                const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_BASE"]}/api/customers/wishlist/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: CATEGORIES_LIST.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$link$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15584f3b._.js.map