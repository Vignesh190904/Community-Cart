...
function CustomerStoreProvider({ children }) {
    ...
    const fetchCart = async ()=>{
        ...
        if (activeToken) {
            ...
            try {
                setIsLoading(true);
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/cart`, {
                    headers: {
    ...
    const addToCart = async (product, maxStock, quantity = 1)=>{
        ...
        if (token) {
            // SERVER ADD
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/cart/add`, {
                    method: 'POST',
                    headers: {
    ...
    const updateQuantity = async (productId, quantity)=>{
        ...
        if (token) {
            // SERVER UPDATE
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/cart/${productId}`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
    ...
    const removeFromCart = async (productId)=>{
        ...
        if (token) {
            // SERVER REMOVE
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/cart/${productId}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
    ...
    const clearCart = async ()=>{
        const token = getToken();
        if (token) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/cart`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb2a8338._.js.map