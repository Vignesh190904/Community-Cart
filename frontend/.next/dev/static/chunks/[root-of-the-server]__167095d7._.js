...
"[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoryPage() {
        ...
        "CategoryPage.useEffect": ()=>{
            const fetchProducts = {
                "CategoryPage.useEffect.fetchProducts": async ()=>{
                    try {
                        setLoading(true);
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/products`);
                        if (!response.ok) {
                        ...
                        const availableProducts = data.filter({
                            "CategoryPage.useEffect.fetchProducts.availableProducts": (p)=>p.isAvailable && p.stock > 0 && p.vendor?.isActive !== false
                        }["CategoryPage.useEffect.fetchProducts.availableProducts"]);
    ...
    const categoryProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[categoryProducts]": ()=>{
            if (!type) return products;
            const categoryType = Array.isArray(type) ? type[0].toLowerCase() : type.toLowerCase();
            return products.filter({
                "CategoryPage.useMemo[categoryProducts]": (p)=>p.category?.trim().toLowerCase() === categoryType
            }["CategoryPage.useMemo[categoryProducts]"]);
        }
    }["CategoryPage.useMemo[categoryProducts]"], [
        type,
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[filteredProducts]": ()=>{
            return categoryProducts.filter({
                "CategoryPage.useMemo[filteredProducts]": (product)=>product.name.toLowerCase().includes(searchQuery.toLowerCase())
            }["CategoryPage.useMemo[filteredProducts]"]);
        }
    }["CategoryPage.useMemo[filteredProducts]"], [
        categoryProducts,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoryPage.useEffect": ()=>{
            const fetchWishlist = {
                "CategoryPage.useEffect.fetchWishlist": async ()=>{
                    try {
                        ...
                        const wishlistedProductIds = new Set(data.map({
                            "CategoryPage.useEffect.fetchWishlist": (item)=>item.product._id
                        }["CategoryPage.useEffect.fetchWishlist"]));
    ...
    const toggleWishlist = async (id)=>{
        ...
        try {
            ...
            if (isCurrentlyWishlisted) {
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$customerFetch$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["customerFetch"])(`${API_BASE}/customers/wishlist/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            !hasDiscount && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {}, void 0, false, {
                                                                fileName: "[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx",
                                                                lineNumber: 261,
                                                                columnNumber: 66
                                                            }, this),
...
_s(CategoryPage, "BeyVYJxQLkKI41Qc6+p1KeEa5no=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/customer/category";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/category.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__167095d7._.js.map