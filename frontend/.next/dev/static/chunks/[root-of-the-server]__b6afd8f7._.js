...
function CustomerDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomerDashboard.useEffect": ()=>{
            const load = {
                "CustomerDashboard.useEffect.load": async ()=>{
                    ...
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["default"].orders.getAll();
                        const mine = data.filter({
                            "CustomerDashboard.useEffect.load.mine": (o)=>o.customerId && (o.customerId._id === cid || o.customerId === cid)
                        }["CustomerDashboard.useEffect.load.mine"]);
                        setOrders(mine);
                    } catch (_) {
                        setOrders([]);
                    } finally{
            ...
            }["CustomerDashboard.useEffect.load"];
            load();
        }
    }["CustomerDashboard.useEffect"], [
        ensureCustomerId
    ...
    const lastOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CustomerDashboard.useMemo[lastOrder]": ()=>{
            if (!orders.length) return null;
            return [
                ...orders
            ].sort({
                "CustomerDashboard.useMemo[lastOrder]": (a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
            }["CustomerDashboard.useMemo[lastOrder]"])[0];
        }
    }["CustomerDashboard.useMemo[lastOrder]"], [
        orders
    ]);
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "card-value",
                                    children: lastOrder ? lastOrder.status : '—'
                                }, void 0, false, {
                                    fileName: "[project]/Desktop/Community-Cart/frontend/src/pages/customer/dashboard.tsx",
                                    lineNumber: 70,
                                    columnNumber: 15
...
_s(CustomerDashboard, "vA/Zgn+6m0YCMJeVInSoDHo1IuY=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6afd8f7._.js.map