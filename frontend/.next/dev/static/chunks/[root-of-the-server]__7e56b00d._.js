...
const getStoredRole = ()=>{
    ...
    if (storedUser) {
        try {
            ...
            const userRole = normalizeRole(parsed?.role);
...
const ProtectedRoute = ({ allowedRoles, children })=>{
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [ok, setOk] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProtectedRoute.useEffect": ()=>{
            ...
            if (!allowedRoles.includes(role)) {
                router.replace(defaultDashboard(role));
                return;
            }
            setOk(true);
        }
...
_s(ProtectedRoute, "WWMAMDBZnF5nqD8LuV0SbOZmob0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
// Patch fetch to always attach Authorization header with cc_token, but block admin-only APIs for non-admins
__turbopack_context__.s([
    "default",
    ()=>__TURBOPACK__default__export__
]);
...
;
var _s = __turbopack_context__.k.signature();
const origFetch = ("TURBOPACK compile-time truthy", 1) ? window.fetch : "TURBOPACK unreachable";
if (("TURBOPACK compile-time value", "object") !== 'undefined' && origFetch) {
    window.fetch = async (input, init = {})=>{
        ...
        // If not admin, block /api/vendors and /api/customers
        if (role !== 'admin' && (url.includes('/api/vendors') || url.includes('/api/customers'))) {
            console.warn(`[app] Blocked admin-only API call to ${url} for non-admin user`);
        ...
        if (token) {
            ...
            console.warn('[app] No cc_token found in localStorage; Authorization header not set');
        }
...
function MyApp({ Component, pageProps }) {
    ...
    if (isAdminPage) {
        content = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$components$2f$ProtectedRoute$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
            allowedRoles: [
                'admin'
            ],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e56b00d._.js.map