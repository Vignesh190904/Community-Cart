...
function AuthProvider({ children }) {
    _s();
    // Check for token immediately to prevent "false" unauthenticated state on first frame
            ...
            const verify_session = {
                "AuthProvider.useEffect.verify_session": async ()=>{
                    ...
                    try {
                        ...
                        // IMPORTANT: Only set loading to false AFTER the check is done
                        set_loading(false);
                    }
                }
    ...
    const sign_in = (user_data, token)=>{
        ...
        if (user_data) set_user(user_data);
        set_is_authenticated(true);
...
function ProfilePage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    // FIX: Destructure using precise snake_case names from updated context
    const { sign_out, update_theme, user, is_authenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(ProfilePage, "sTkc+je9Ukhiy1uenjVPMocn69A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__990173e5._.js.map