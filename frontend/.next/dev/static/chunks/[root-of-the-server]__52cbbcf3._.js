...
_s(CustomerLayout, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
function CustomerStoreProvider({ children }) {
    ...
    const addToCart = (product, maxStock)=>{
        setCart((prev)=>{
            ...
            const limit = typeof maxStock === 'number' ? Math.max(0, maxStock) : Infinity;
            if (existing) {
    ...
    const updateQuantity = (productId, quantity)=>{
        setCart((prev)=>{
            ...
            return prev.map((item)=>item.product._id === productId ? {
                    ...item,
                    quantity
                } : item);
        });
...
function BrowseProducts() {
    _s();
    const { addToCart, ensureCustomerId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$context$2f$CustomerStore$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useCustomerStore"])();
                ...
                "BrowseProducts.useEffect.load": async ()=>{
                    ...
                    try {
                        ...
                        const available = data.filter({
                            "BrowseProducts.useEffect.load.available": (p)=>p.isAvailable !== false
...
_s(BrowseProducts, "IdrTmZ68/MXytVysb6GyP1zYNyU=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52cbbcf3._.js.map