        ...
        if (token) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    // Optional: alert(`Some items were removed: ${data.removedItems.join(', ')}`);
                    }
                } else if (res.status === 401) {
                // Token invalid, fallback to local? or just clear?
                // For stability, let's treat as guest
                }
            } catch (err) {
...
_s(CustomerStoreProvider, "w7oL7/jMvFxWnEIzG+g9qm+upcg=");
...
"[project]/Desktop/Community-Cart/frontend/src/pages/customer/product/[id].tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(ProductDetailPage, "L7ClX+bsUPIsue04g23tk1rYY8c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/product/[id].tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/customer/product/[id]";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/Desktop/Community-Cart/frontend/src/pages/customer/product/[id].tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/product/[id].tsx\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/customer/product/[id].tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__0ef79171._.js.map