...
"[project]/Desktop/Community-Cart/frontend/src/pages/admin/customers.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminCustomers() {
    ...
    const loadCustomers = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["api"].customers.getAll();
            setCustomers(data);
        } catch (error) {
            pushToast({
                type: 'error',
    ...
    // ========== LIST FILTERS ==========
    const [customerSearch, setCustomerSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [debouncedCustomerSearch, setDebouncedCustomerSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [hasOrdersFilter, setHasOrdersFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('all');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminCustomers.useEffect": ()=>{
            const t = setTimeout({
                "AdminCustomers.useEffect.t": ()=>setDebouncedCustomerSearch(customerSearch.trim())
            }["AdminCustomers.useEffect.t"], 300);
            return ({
                "AdminCustomers.useEffect": ()=>clearTimeout(t)
            })["AdminCustomers.useEffect"];
        }
    }["AdminCustomers.useEffect"], [
        customerSearch
    ]);
    const customerOrdersMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminCustomers.useMemo[customerOrdersMap]": ()=>{
            const map = new Map();
            orders.forEach({
                "AdminCustomers.useMemo[customerOrdersMap]": (o)=>{
    ...
    const filteredCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminCustomers.useMemo[filteredCustomers]": ()=>{
            let list = [
                ...customers
            ];
            ...
            if (debouncedCustomerSearch) {
                ...
                list = list.filter({
                    "AdminCustomers.useMemo[filteredCustomers]": (c)=>{
            ...
            // Status
            list = list.filter({
                "AdminCustomers.useMemo[filteredCustomers]": (c)=>statusFilter === 'active' ? c.isActive : !c.isActive
            }["AdminCustomers.useMemo[filteredCustomers]"]);
            // Has orders
...
_s(AdminCustomers, "/jxkCDwiS1NzmQ1O+hO7PwjbGdA=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/admin/customers.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/admin/customers";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/Desktop/Community-Cart/frontend/src/pages/admin/customers.tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/Desktop/Community-Cart/frontend/src/pages/admin/customers.tsx\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/Desktop/Community-Cart/frontend/src/pages/admin/customers.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__b4f331df._.js.map