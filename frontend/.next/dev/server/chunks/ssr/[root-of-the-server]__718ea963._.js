...
function VendorsManagement() {
    ...
    const handleEdit = async (id)=>{
        try {
            const vendor = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["api"].vendors.getById(id);
            setFormData(vendor);
            setEditingId(id);
            setMode('edit');
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__718ea963._.js.map