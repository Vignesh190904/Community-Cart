...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const rehydrateAuth = async ()=>{
            ...
            try {
                ...
                const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$api$2e$utils$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["apiGet"])(endpoint);
    ...
    const update_theme = async (theme)=>{
        ...
        if (user) {
            ...
            if (token) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Community$2d$Cart$2f$frontend$2f$src$2f$utils$2f$api$2e$utils$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["apiPatch"])('/api/customers/ui-preferences', {
                        theme
                    });
                } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d835ae8._.js.map